      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center p-4">
        <div className="bg-white rounded-3xl shadow-2xl max-w-md w-full p-8">
          <div className="text-center mb-6">
            <div className="w-24 h-24 bg-white rounded-full flex items-center justify-center mx-auto mb-4 shadow-xl p-3 border-4 border-green-500">
              <img src="/playita.png" alt="La Playita Logo" className="w-full h-full object-contain" />
            </div>
          ...
          <a
            href="https://laplayita-production.up.railway.app/"
            className="block w-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold py-3 rounded-xl hover:shadow-lg transition-all text-center"
          >
            Ir al Login
          </a>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5">
            ...
            <div className="lg:col-span-2 bg-gradient-to-br from-blue-500 to-purple-600 p-8 lg:p-12 text-white relative overflow-hidden">
              ...
              <div className="relative z-10">
                <div className="w-32 h-32 bg-white rounded-full flex items-center justify-center mb-6 shadow-xl p-3">
                  <img src="/playita.png" alt="La Playita Logo" className="w-full h-full object-contain" />
                </div>
              ...
              <div className="max-w-xl mx-auto">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="text-center pt-4 border-t border-gray-200">
                    ...
                    <a href="https://laplayita-production.up.railway.app/" className="text-blue-600 font-semibold hover:underline">
                      Inicia sesión aquí
                    </a>
                  </div>
                </form>
